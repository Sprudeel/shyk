        ...
        <div class="grid w-full grid-cols-7 grid-rows-1 items-start gap-4 p-2">
            ...
            <div class="col-span-6 rounded-lg border border-slate-200 p-4">
                ...
                <div v-if="props.comment.subcomments">
                    <div v-for="subcomment in props.comment.subcomments">
                        <div
                            class="grid w-fit grid-cols-7 grid-rows-1 items-center gap-4 p-2"
                        >
                            <div class="w-fit">
                                <Link
                                    :href="
