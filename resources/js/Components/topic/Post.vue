...
<template>
    <div
        class="mb-8 max-w-3xl cursor-pointer rounded-lg border border-slate-300 bg-white p-4 shadow-lg hover:scale-105"
    >
        <div class="grid grid-cols-3 grid-rows-3">
            <div class="col-span-2 self-center text-xl font-bold">
                {{ props.data.title }}
            </div>
            <span
                :style="
            ...
            <span class="row-span-2 flex flex-row items-center space-x-4">
                <img
                    :src="
