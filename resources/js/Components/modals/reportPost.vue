...
let form = useForm({
    reported_post: props.data.id,
    reported_post_title: props.data.title,
    reason: "",
});

const submit = () => {
    form.post(route("post.report"));
...
<template>
    ...
    >
        <div class="items-center justify-center pt-1">
            ...
            />
            <h2 class="mb-4 text-left text-lg font-bold">Post melden</h2>
            <form @submit.prevent="submit">
                ...
                <Input
                    ...
                    v-model="form.reported_post_title"
                    required
                    autofocus
                    disabled
                />
